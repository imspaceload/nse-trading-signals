...
SYMBOLS = {
    ...
    "MCX COPPER":       {"yf": "HG=F",   "nse": "",  "mcx": "COPPER",     "tv": "MCX:COPPER1!"},
    "MCX ALUMINIUM":    {"yf": "",        "nse": "",  "mcx": "ALUMINIUM",  "tv": "MCX:ALUMINIUM1!"},
    "MCX ZINC":         {"yf": "",        "nse": "",  "mcx": "ZINC",       "tv": "MCX:ZINC1!"},
    "MCX LEAD":         {"yf": "",        "nse": "",  "mcx": "LEAD",       "tv": "MCX:LEAD1!"},
    "MCX NICKEL":       {"yf": "",        "nse": "",  "mcx": "NICKEL",     "tv": "MCX:NICKEL1!"},
    # ── NIFTY 50 Stocks ──
    ...
    "AUBANK":           {"yf": "AUBANK.NS",       "nse": "AUBANK",      "tv": "NSE:AUBANK"},
    "KARURVYSYA":       {"yf": "KARURVYSYA.NS",   "nse": "KARURVYSYA",  "tv": "NSE:KARURVYSYA"},
    "DCBBANK":          {"yf": "DCBBANK.NS",      "nse": "DCBBANK",     "tv": "NSE:DCBBANK"},
    "SOUTHBANK":        {"yf": "SOUTHBANK.NS",    "nse": "SOUTHBANK",   "tv": "NSE:SOUTHBANK"},
    "HDFCAMC":          {"yf": "HDFCAMC.NS",      "nse": "HDFCAMC",     "tv": "NSE:HDFCAMC"},
    "SBICARD":          {"yf": "SBICARD.NS",      "nse": "SBICARD",     "tv": "NSE:SBICARD"},
    "M&MFIN":           {"yf": "M&MFIN.NS",       "nse": "M&MFIN",      "tv": "NSE:M_MFIN"},
    "LTFH":             {"yf": "LTFH.NS",         "nse": "LTFH",        "tv": "NSE:LTFH"},
    ...
    # ── IT / Technology ──
    "CYIENT":           {"yf": "CYIENT.NS",       "nse": "CYIENT",      "tv": "NSE:CYIENT"},
    "BIRLASOFT":        {"yf": "BIRLASOFT.NS",    "nse": "BIRLASOFT",   "tv": "NSE:BIRLASOFT"},
    "INTELLECT":        {"yf": "INTELLECT.NS",    "nse": "INTELLECT",   "tv": "NSE:INTELLECT"},
    "AFFLE":            {"yf": "AFFLE.NS",        "nse": "AFFLE",       "tv": "NSE:AFFLE"},
    "ROUTE":            {"yf": "ROUTE.NS",        "nse": "ROUTE",       "tv": "NSE:ROUTE"},
    ...
    "TVSMOTOR":         {"yf": "TVSMOTOR.NS",     "nse": "TVSMOTOR",    "tv": "NSE:TVSMOTOR"},
    "EXIDEIND":         {"yf": "EXIDEIND.NS",     "nse": "EXIDEIND",    "tv": "NSE:EXIDEIND"},
    "AMARARAJA":        {"yf": "AMARAJABAT.NS",   "nse": "AMARAJABAT",  "tv": "NSE:AMARAJABAT"},
    ...
    "DMART":            {"yf": "DMART.NS",        "nse": "DMART",       "tv": "NSE:DMART"},
    "TRENT":            {"yf": "TRENT.NS",        "nse": "TRENT",       "tv": "NSE:TRENT"},
    "EIHOTEL":          {"yf": "EIHOTEL.NS",      "nse": "EIHOTEL",     "tv": "NSE:EIHOTEL"},
    "LEMONTRE":         {"yf": "LEMONTRE.NS",     "nse": "LEMONTRE",    "tv": "NSE:LEMONTRE"},
    "DEVYANI":          {"yf": "DEVYANI.NS",      "nse": "DEVYANI",     "tv": "NSE:DEVYANI"},
    "SAPPHIRE":         {"yf": "SAPPHIRE.NS",     "nse": "SAPPHIRE",    "tv": "NSE:SAPPHIRE"},
    # ── Energy / Power ──
    "PETRONET":         {"yf": "PETRONET.NS",     "nse": "PETRONET",    "tv": "NSE:PETRONET"},
    "IGL":              {"yf": "IGL.NS",          "nse": "IGL",         "tv": "NSE:IGL"},
    "MGL":              {"yf": "MGL.NS",          "nse": "MGL",         "tv": "NSE:MGL"},
    "SUZLON":           {"yf": "SUZLON.NS",       "nse": "SUZLON",      "tv": "NSE:SUZLON"},
    "GMRINFRA":         {"yf": "GMRINFRA.NS",     "nse": "GMRINFRA",    "tv": "NSE:GMRINFRA"},
    ...
    # ── Metals & Mining ──
    "HINDCOPPER":       {"yf": "HINDCOPPER.NS",   "nse": "HINDCOPPER",  "tv": "NSE:HINDCOPPER"},
    ...
    # ── PSU / Infrastructure ──
    "INDUSTOWER":       {"yf": "INDUSTOWER.NS",   "nse": "INDUSTOWER",  "tv": "NSE:INDUSTOWER"},
    "IRB":              {"yf": "IRB.NS",          "nse": "IRB",         "tv": "NSE:IRB"},
